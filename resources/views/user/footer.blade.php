            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <ul class="social-link">
                        <li>
                            <a href="https://m.facebook.com/profile.php?id=100048753290148" target="_blank"><i class='bx bxl-facebook'></i></a>
                        </li> 
                        
                        <li>
                            <a href="https://www.instagram.com/llosteopathie_mauritius/?hl=en" target="_blank"><i class='bx bxl-instagram'></i></a>
                        </li> 
                        
                        <li>
                            <a href="https://api.whatsapp.com/send?phone=23052537344&text=LLosteo.com%20AmandineLeca%20&utm_campaign=alwayson&utm_content=paid&lang=en" target="_blank"><i class='bx bxl-whatsapp'></i></a>
                        </li> 
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-widget">
                    ...
                    <ul class="footer-list">
                        ...
                        <li>
                            <a href="{{ url('/termsconditions',['lang' => App::getLocale()]) }} }}">
                                <i class='bx bxs-chevron-right'></i>
...
<div class="copy-right-area">
    <div class="container">
        <div class="copy-right-text text-center">
            <p>
              {{ __('msg.Copyright ') }} <script>document.write(new Date().getFullYear())</script> © L & L Ostéopathie {{ __('msg.All Right Reserved by ') }}
