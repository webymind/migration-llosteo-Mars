...
<head>
    ...
    <meta name="keywords"
        content="Chiropractor in Mauritius, Osteopath in Mauritius, Book a consultation, back pain, neck pain, stress, insomia, body balance, osteopath in mauritius. ">
    ...
    <meta property="og:type"
        content=" Ostéopahie website | Website | Osteopahie site in Mauritius | Osteopath Booking Appointment | Osteopath consultation Mauritius | OSTEOPATH MAURITIUS">
    <meta property="og:description"
        content="Looking for a chiropractor or osteopath in Mauritius? Suffering from back pain, neck pain? Book an appointment for a consultation with your osteopath.">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="top-0 right-0 px-6 py-0 sm:block">
                                    ...
                                    <a href="{{ url('/dashboard') }}"
                                        class="text-sm text-gray-700 dark:text-gray-500 underline">{{ __('msg.SELFCARE') }}</a>
                                    @else
                                    <a href="{{ route('login') }}"
                                        class="text-sm text-gray-700 dark:text-gray-500 underline">@lang('msg.Log
                                        in')</a>
                                    <span> | </span>
                                    @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">@lang('msg.Register')</a>
                                    @endif
                                    @endauth
                                </div>
                                @endif
